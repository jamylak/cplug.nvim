...
sh "$ROOT_DIR/scripts/test-demo-fixture-runner.sh"
sh "$ROOT_DIR/scripts/test-run-demo-plugin-discovery.sh"
sh "$ROOT_DIR/scripts/test-fixture-launch-selection.sh"
sh "$ROOT_DIR/scripts/test-fixture-projects.sh"
